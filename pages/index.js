...
export default function Home() {
  ...
  //Book Search
  const [showModalBookSearch, setShowModalBookSearch] = useState(false);

  const handleCloseModalBookSearch = () => setShowModalBookSearch(false);
  const handleShowModalBookSearch = () => setShowModalBookSearch(true);
  ...
  return (
    <>
      ...
      <div className="portfolio-item-wrapper" data-aos="fade-down">
                <div className="portfolio-img-background" id="project-18"></div>
                ...
                <div className="img-text-wrapper">
                  ...
                  <h5 className="subtitle">Book Search</h5>
                  <div className="d-flex flex-row">
                    <a href="https://book-search-luigi009.vercel.app/#/" target="_blank" rel="noopener noreferrer">
                      <FontAwesomeIcon className="jello-horizontal fontAwesomeIcon" icon={faLink} style={{marginRight: "15px"}} />
                    </a>
                    <a href="#moviesSeriesInfoModalImages" id="moviesSeriesInfoModalInput" onClick={handleShowModalBookSearch}>
                      <FontAwesomeIcon className="jello-horizontal fontAwesomeIcon" icon={faSearchPlus} />
                    </a>
                      {/* <!-- Modal --> */}
                      <Modal show={showModalBookSearch} onHide={handleCloseModalBookSearch} size="lg" centered>
                        <Modal.Header closeButton>
                          <Modal.Title>Images from the book search site</Modal.Title>
                        </Modal.Header>
                        <Modal.Body>
                        <Carousel>
                        <Carousel.Item>
                              <img
                                src={ prefix + '/img/modalImg/bookSearch-modal-image-1.jpg'}
                                alt="First slide"
                                width={800}
                                height={600}
                              />
                            ...
                            <Carousel.Item>
                              <img
                                src={ prefix + '/img/modalImg/bookSearch-modal-image-2.jpg'}
                                alt="First slide"
                                width={800}
                                height={600}
                              />
                            ...
                            <Carousel.Item>
                              <img
                                src={ prefix + '/img/modalImg/bookSearch-modal-image-3.jpg'}
                                alt="First slide"
                                width={800}
                                height={600}
                              />
                            ...
                            <Carousel.Item>
                              <img
                                src={ prefix + '/img/modalImg/bookSearch-modal-image-4.jpg'}
                                alt="First slide"
                                width={800}
                                height={600}
                              />
                        ...
                        <Modal.Footer>
                          <Button variant="secondary" onClick={handleCloseModalBookSearch}>
                            Close
                          </Button>
                        </Modal.Footer>
                      </Modal>
              ...
              <div className="portfolio-item-wrapper" data-aos="fade-down">
                ...
                <div className="img-text-wrapper">
                  <div className="logo-wrapper d-flex">
                    ...
                    <FontAwesomeIcon icon={faReact} className="fontAwesomeIcon" style={{color: "#fff", marginRight: "15px", marginLeft: "15px"}} />
                    <svg xmlns="http://www.w3.org/2000/svg" height="45px" fill="currentColor" className="bi bi-bootstrap-fill" viewBox="0 0 16 16">
